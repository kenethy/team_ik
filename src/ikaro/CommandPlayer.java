...
public class CommandPlayer extends Thread{
	...
	public void run(){
		...
		switch (selfPerc.getUniformNumber()){
			case 1: acaoGoleiro(nextIteration); break;
			case 2: acaoArmador(nextIteration, -15); break; //na pos (2o parametro), 0 é a linha horizontal com o meio do campo, nesse parametro, o -10 é somado ao 0
			case 3: acaoArmador(nextIteration, 15); break;
			case 4: acaoArmador(nextIteration, 0); break;
			case 5: acaoAtacante(nextIteration, 0); break;
			case 6: acaoAtacante(nextIteration, 15); break;
			case 7: acaoAtacante(nextIteration, -15); break;
			default : break;
		}
	}
			...
			switch (matchPerc.getState()) {
				...
				case PLAY_ON:
					if(isPointsAreClose(selfPerc.getPosition(),ballPos, 1)){
						...
						double intensity =(vTempF.magnitude()*100)/40;kickToPoint(vTemp, intensity);
					}else{
